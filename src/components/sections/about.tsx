      ...
      <div className="container px-4 md:px-6 mx-auto max-w-6xl relative z-10">
        ...
        <div className="text-center mb-8">
          <div className="inline-flex items-center gap-2 px-4 py-1.5 rounded-full bg-primary/15 border border-primary/25 text-primary font-semibold text-sm mb-3">
            <Terminal className="w-4 h-4" /> {t("label")}
          </div>
          ...
          >
            ...
            <CardContent className="p-6 md:p-8 space-y-5">
              <div className="flex items-center gap-2 text-primary font-semibold text-lg">
                <Cpu className="w-5 h-5" /> {t("mindset_label")}
              </div>
            ...
            <CardContent className="p-0 h-full flex flex-col">
              <div className="p-6 border-b border-[#FF8C42]/10 flex items-center justify-between">
                <div className="flex items-center gap-2 text-[#FF8C42] font-semibold">
                  <Layers className="w-5 h-5" /> {t("stack_label")}
                </div>
              ...
              <div className="p-6 grid sm:grid-cols-2 gap-8">
                <div className="space-y-3">
                  <h4 className="text-xs font-bold uppercase text-muted-foreground tracking-wider flex items-center gap-2">
                    <Code2 className="w-3 h-3" /> {t("core_label")}
                  </h4>
                ...
                <div className="space-y-3">
                  <h4 className="text-xs font-bold uppercase text-muted-foreground tracking-wider flex items-center gap-2">
                    <Database className="w-3 h-3" /> {t("cs_label")}
                  </h4>
                  <div className="flex flex-wrap gap-2">
